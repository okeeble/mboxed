    ...
    centos)
      case "$OS_VERSION" in
        ...
        8)
          ...
          docker_scanplugin_url=$DOCKER_URL_CENTOS8'docker-scan-plugin-'$DOCKER_SCANPLUGIN_VERSION'-3.el8.x86_64.rpm'
          docker_rootless_extras=$DOCKER_URL_CENTOS8'docker-ce-rootless-extras-'$DOCKER_VERSION'-3.el8.x86_64.rpm'
